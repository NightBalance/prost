...
impl Field {
        ...
        match self.label {
            Label::Optional => quote! {
                if let Some(ref msg) = #ident {
                    crate::alligator::proto_google_08::encoding::group::encode(#tag, msg, buf);
                }
            },
            Label::Required => quote! {
                crate::alligator::proto_google_08::encoding::group::encode(#tag, &#ident, buf);
            },
    ...
    pub fn merge(&self, ident: TokenStream) -> TokenStream {
        match self.label {
            Label::Optional => quote! {
                crate::alligator::proto_google_08::encoding::group::merge(
                    tag,
                    wire_type,
            ...
            Label::Required => quote! {
                crate::alligator::proto_google_08::encoding::group::merge(tag, wire_type, #ident, buf, ctx)
            },
            Label::Repeated => quote! {
                crate::alligator::proto_google_08::encoding::group::merge_repeated(tag, wire_type, #ident, buf, ctx)
            },
        }
    }
    ...
    pub fn encoded_len(&self, ident: TokenStream) -> TokenStream {
        ...
        match self.label {
            Label::Optional => quote! {
                #ident.as_ref().map_or(0, |msg| crate::alligator::proto_google_08::encoding::group::encoded_len(#tag, msg))
            },
            Label::Required => quote! {
                crate::alligator::proto_google_08::encoding::group::encoded_len(#tag, &#ident)
            },
            Label::Repeated => quote! {
                crate::alligator::proto_google_08::encoding::group::encoded_len_repeated(#tag, &#ident)
            },
        }
    }
